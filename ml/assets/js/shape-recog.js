...
Highcharts.chart('shapeRecognition-main-chart', {
    ...
    title: {
        text: 'Total Error Rate of Various Methods in Shape Recognition',
        style: {
            color: 'black',
            fontSize: '22px',
            // fontWeight: 'bold',
    ...
    subtitle: {
        text: '<span style="font-size:19px; color: red;">Random Seed = 1, Same Train/Test Split</span><br>Click the columns to view each method in details.',
        style: {
            color: 'black',
            fontSize: '15px'
        }
